...
/// A cross-field RFC 5545/7953/9074 rule a component builder — either the
/// parser's internal one or a public [`crate::components`] builder — found
/// violated once every property on the component was known.
#[derive(thiserror::Error, Debug)]
pub enum ComponentError {
    /// A property RFC 5545 requires on this component wasn't present.
